Feature: Testcases for the modules in caregiver mobile app
    ...
    Scenario Outline: Verify that "Caregiver" is able to add nutrition "Bottle" details of patient also Verify the "Caregiver" is able to add "New Breast Milk",Formula and fortification
        ...
        When For ios, when user click on + Add New Milk option
        When For ios, when user click on <selectMilk2> option
        When I Click on radio button <selectMilk>
        # When User click on the button with text Save
        When I Click on select milk field
        When For ios, when user click on + Add New Milk option
        When For ios, when user click on <milkType2> option
        ...
        When For ios, when user click on + Add New Fortifier option
        ...
        Examples:
            | validLoginEmail | firstChild        | minutes | selectMilk  | bottleVolumn | fortification | calories | note                                              | selectMilk2 | milkType2 | formulaName       |
            | FHDCMobileLogin | Patient_Auto_Test | 10      | Mother Milk | 50           | Auto test     | 20       | Observe Your Baby’s Response while Bottle Feeding | Breast Milk | Formula   | Auto test formula |
    ...
    Scenario Outline: Verify that "Caregiver" is able to add nutrition "Bottle" details of patient when start and pause automatic timer
        ...
        When User click on the button with text Save
        # Then Validation message appears Please stop the timer
        ...
        Examples:
            ...
            | FHDCMobileLogin | Patient_Auto_Test | 10      | Auto test formula | 40           | Auto test     | 20       | Observe Your Baby’s Response while Bottle Feeding |



    Scenario Outline: Verify that "Caregiver" is able to add nutrition "Breast Feed" details of patient
        When For ios user click on the Left Breast button
        Then I get navigated to Add Manual Time screen
        When User click on the button with text Save
        ...
        When For ios I fill <minutes> data in "Minutes" field
        When User click on the button with text Save
        When For ios user click on the Right Breast button
        Then I get navigated to Add Manual Time screen
        When User click on the button with text Save
        # Then Validation message appears Please select time brefore saving data
        When I click on Add Manual Time option
    ...
    Scenario Outline: Verify that "Caregiver" is able to add nutrition "Gavage Fed" details of patient
        When For ios user click on the Gavage Fed button
        Then I get navigated to Select Milk screen
        When I click on Add Manual Time option
        # Then I get navigated to Time screen
        When User click on the ios button with second index Save
        ...
        Examples:
            ...
            | 10      | Mother Milk | 50           | Auto test     | 20       | Observe Your Baby’s Response while Bottle Feeding | Gavage Fed     |
    ...
    Scenario Outline: Verify that "Caregiver" is able to add nutrition "Gavage Fed" details of patient with automatic timer
        ...
        Examples:
            | minutes | selectMilk  | bottleVolumn | fortification | calories | note                                    | startingModule |
            | 10      | Mother Milk | 60           | Auto test     | 20       | Observe Your Baby’s Response Gavage fed | Gavage Fed     |
    ...
    Scenario Outline: Verify the "Caregiver" is able to view and Edit "Growth" results added by the provider through web and Verify the "Caregiver" is able to delete "Growth" results added by the provider through web
        ...
        When User click on the button with text Update
        Then Added sleep data <updatedHeightInch> should displaying after save
        Then Added sleep data <updatedWeightPound> should displaying after save
        Then Added sleep data <updateWeightOunce> should displaying after save
        Then Added sleep data <updatedHeadCircumference> should displaying after save
...
# Then I get navigated to Edit Growth screen
        ...
        # Then Validation message appears Please select date
        When User selects date in "Date" field
        When User click on the button with text Select
        ...
        When User click on the button with text Edit Growth
        Then I get navigated to Growth List screen
        Then Added sleep data <heightInch> should displaying after save
        Then Added sleep data <weightPound> should displaying after save
        Then Added sleep data <weightOunce> should displaying after save
        Then Added sleep data <headCircumference> should displaying after save
        Examples:
    ...
    Scenario Outline: Verify that "Caregiver" is able to add "Sleep" details of patient
        ...
        When User click on the button with text Pause
        When User click on the button with text Save
        # Then Added sleep data secs should displaying after save
        Examples:
            | minutes | startingModule |
            | 10      | Sleep          |
    ...
    Scenario Outline: Verify that "Caregiver" is able to add "Diapering" details of patient
        When scrol to option
        When I click on Diapering option
        When For ios user click on the Pee button
        ...
        When For ios user click on the Poo button
        ...
        Then Added sleep data <note> should displaying after save
        Then Added sleep data <diaperWeight> should displaying after save
        When For ios user click on the Both button
