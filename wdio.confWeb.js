...
exports.config = {
  ...
  suites: {
    ...
    contactUs_TrackerPage: [
      "./features/Web/SuperAdmin/contactUs_Tracker.feature",
    ],
    contactUs_Tracker_iOSPage: [
      "./features/Web/SuperAdmin/contactUs_Tracker_iOS.feature",
    ],

    downloadAppsPage: ["./features/Android/downloadApp.feature"],
    newCaregiverPatientPage: [
      "./features/Web/ManagingProviderAccount/caregiver_Patient.feature",
    ],
    ...
    webOtherProviderPage: [
      "./features/Web/OtherProviderAccount/patient_Records.feature",
    ],
  },
  exclude: [
